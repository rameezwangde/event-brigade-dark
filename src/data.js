...
export const testimonials = [
  {
    quote:
      "So exactly a month ago, my wife and I got married at Evershine Resort in Mahabaleshwar and the entire event turned out to be a sensation and unforgettable experience for not just us but also our friends and families, all thanks to the Event Brigade team, especially Kunal, Neha, Sandip and Ujjwal!\n\nWe both live abroad and in our family, there were not enough young people to manage the wedding so we decided to look for an event planning team. Many of our relatives recommended Kunal and Event Brigade.\n\nInitially I was quite skeptical because my experience of working with an event team in the past was not great but after the first meeting with Kunal, I felt very calm.\n\nWe were to going to spend a lot on various aspects of the wedding and our primary concern was that the experience of each guest right from check-in to check-out should be extremely smooth and also that the aesthetic and artistic look of the event should feel at the same level as the money being spent. This was our brief to Kunal's team.\n\nWe believe that we were quite a difficult couple to work with since we had very particular expectations and demands from the team. We wanted a really good designer for designing our wedding cards, stationery and gift box and Kunal recommended us someone who did this for us with such dedication and passion that everything turned out to be great at the end and everyone loved it.\n\nAll the vendors recommended to us by Kunal and his team were done in a very transparent manner and I believe that honesty and open communication are the key hallmarks of this team. The anchor they recommended us fit our brief to the T and the events in which the anchor performed were the most loved events.\n\nWe were very particular about the decor, so much so that we took around 3 months to finalise the draft designs and concepts and this was the most worrisome part for us. But Kunal and Event Brigade understood our brief so well and recommended us the best decorator and everyone absolutely loved the decor and couldn't stop praising all the decor.\n\nThe sound provided by Kunal for all the events was very good since sound was another thing I was quite particular about and it had a very good quality without being too faint or too loud. This raised the profile of the final musical evening event especially which I believe was the highlight of the wedding.\n\nThe wedding was a huge success also because the support team of Kunal including Kajal, Neha, Sandip, Ujjwal as well as the shadows and junior support staff during the wedding was extremely competent and experienced in handling big and complicated events like Indian wedding.\n\nWe had 16 guests coming from abroad which needed end to end management from airport pickup, pre-wedding hotel check-ins to wedding hospitality to airport drop offs. Kunal's team managed the logistics so well and also helped make pre-wedding room hampers which everyone loved.\n\nKunal's team also worked really hard for the pre-wedding events including Mehendi which was done at our residence and was a big hit. His team also coordinated well with my own vendors whom I went ahead with without any friction such as the musicians, photographers and other vendors that we had.\n\nOverall, I believe that Event Brigade is a great event management team and if you have any event, big or small, you should go ahead with them without a second thought because this team is dedicated, professional, and most importantly honest and transparent. They manage your event as if their own event and that is what makes them stand apart.\n\nI am planning on doing some small events in Pune in the future and they are going to be my choice to manage these events for me!",
    name: "Keyshav Mor",
    role: "Groom"
  },
  {
    quote:
      "We had engaged Event Brigade for our son’s 5th b’day celebration. Event Brigade, under the leadership of Kunal Garg, has set a benchmark in event management. Kunal showed commitment in meeting our (customer) expectations right from the initial planning stages to execution. His dedication went beyond simply delivering an event, he created memorable experiences that reflect the client’s vision.\n\nWhat truly sets Kunal apart is his ability to listen, adapt, and ensure that every requirement is not only met but exceeded. His team’s professionalism, coupled with his hands-on involvement, guarantees seamless coordination and impeccable results.",
    name: "Amol Nehru",
    role: "Parent"
  },
  {
