      ...
      <div className="relative mx-auto max-w-7xl px-5">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-12 top-0 flex flex-col items-center justify-center px-6 pt-10 text-center md:bottom-16 md:pt-12">
            ...
            <p className="relative z-10 mt-4 text-sm font-semibold uppercase tracking-[0.36em] text-champagne drop-shadow-[0_2px_14px_rgba(0,0,0,1)] md:text-base">THE EVENT BRIGADE VIBE</p>
            ...
            <p className="relative z-10 mt-6 max-w-3xl text-sm leading-8 text-smoke drop-shadow-[0_2px_14px_rgba(0,0,0,1)] md:text-base">
              Event curation shouldn't feel like a high-pressure operations test. As your brigade, we take over the complex staging, technical production, and on-ground logistics with surgical precision—transforming raw chaos into flawless, stress-free luxury. We rescue the details so you can own the spotlight.
            </p>
            <div className="relative z-10 mt-8 flex items-center gap-3 rounded-full border border-champagne/25 bg-obsidian/75 px-5 py-2 text-xs uppercase tracking-[0.24em] text-gold backdrop-blur">
              <ShieldCheck size={16} /> 1500+ successful projects executed
            </div>
          </div>
        </motion.div>
      </div>
