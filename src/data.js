...
export const siteCopy = {
  ...
  about:
    'A squad of event enthusiasts and event managers to rescue you from the worry of organizing and managing an event of your life makes an Event Brigade! Event Brigade is a team of young, creative, enthusiastic and dynamic professionals with a sparkling stream of ideas having solid experience in the field of Events & Entertainment. We would like to be the first choice of all organizations and families looking for unique and personalized events. We are dedicated to conceiving, designing and executing events that exceed their expectations. We are here to make things easier and provide excellent services to our clients. Every event organized, managed and coordinated by us is an excellent opportunity for entertainment, growth, personality development and confidence building for our clients. From our in-house staff to all of our clients and participants, everyone have experienced the magic.',
  company:
    'Event Brigade operates in entertainment, media and communication and many more things. We offer a comprehensive and integrated range of services to our clients. Event Brigade is widely recognized as a holistic events solution factory. We believe that every minute detail must be acknowledged and attended to, which translates into a positive and favorable experience for the target audience. Our goal is to give each & every event a different Meaning, Identity and a Vision with true professionalism to chart the roads of informative & entertaining events.',
  philosophy:
