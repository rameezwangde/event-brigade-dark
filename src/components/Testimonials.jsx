          ...
          >
            {[...testimonials, ...testimonials].map((testimonial, testimonialIndex) => {
              ...
              <button
                ...
                className={`relative flex flex-col justify-between min-h-[260px] w-[78vw] shrink-0 rounded-[1.25rem] border bg-[linear-gradient(145deg,rgba(248,241,223,0.08),rgba(248,241,223,0.025))] p-5 text-left shadow-soft transition duration-300 sm:w-[380px] md:p-6 ${
                  isOpen
